    ...
    <div className='flex items-center justify-center h-screen'>
      ...
      <div className="bg-green-600 text-white text-lg font-semibold p-2 rounded-md mb-2">
        ...
        <div className='flex justify-between mt-4'>
          <button className='bg-save hover:bg-save-hover text-white font-bold py-2 px-4 rounded'>Save</button>
          <button className='bg-cancel hover:bg-cancel-hover text-white font-bold py-2 px-4 rounded'>Cancel</button>
        </div>
