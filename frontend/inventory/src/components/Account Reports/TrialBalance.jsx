...
const TrialBalance = () => {
  const [selectedReportType1, setSelectedReportType1] = useState(""); // 
  // "all" or "particulars"
  const [selectedReportType2, setSelectedReportType2] = useState("");
      ...
      />
          ...
          <label className="block">
              <input
                ...
                value="particulars"
                className="mr-2"
                onChange={() => handleReportTypeChange2("summary")}
            ...
            <label className="block">
              <input
                ...
                value="particulars"
                className="mr-2"
                onChange={() => handleReportTypeChange2("in-detail")}
