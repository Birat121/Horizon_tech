...
const NoPurchaseSinceDateButStockAvi = () => {
  ...
  return (
    <div className="flex flex-col h-[90vh] rounded-lg overflow-y-auto bg-gray-50 ml-8">
...
export default NoPurchaseSinceDateButStockAvi;
