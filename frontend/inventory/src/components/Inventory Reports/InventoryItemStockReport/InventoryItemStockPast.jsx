            ...
            <div className="border border-gray-300 p-4 rounded mb-4">
              ...
              <label className="block">
                <input
                  ...
                  className="mr-2"
                  onChange={() => handleVendorTypeChange("particularProduct")}
                  checked={selectedVendorType === "particularProduct"}
                />
                Particular Product
              </label>
              ...
              <div className="mb-4">
                <select
                  className="w-full p-2 border border-gray-400 rounded mb-2"
                  disabled={selectedVendorType !== "particularProduct"}
                >
                  <option>Select Category</option>
                  <option>Category 1</option>
                  <option>Category 2</option>
...
export default InventoryItemStockPast;
