export const menus = [
  {
    ...
    items: [
      ...
      { path: "/master/suboption3", label: "Additional Expenses Ledger Mapping" },
  ...
  { path: "/transaction/suboption14", label: "Barcode Print With Expire Date" },
  ...
  { path: "/accountreports/suboption8", label: "Balance Confirmation(Vendor / Customer)" },
  { path: "/accountreports/suboption9", label: "General Ledger Detail" },
  { path: "/accountreports/suboption10", label: "General Ledger With Product Detail" },
  { path: "/accountreports/suboption11", label: "Receivable / Payable Summary Report" },
  { path: "/accountreports/suboption12", label: "Ageing analysis Reports" },
  { path: "/accountreports/suboption13", label: "Invoice Wise Ageing Analysis" },
